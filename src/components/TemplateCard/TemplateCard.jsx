  ...
  return (
    ...
    >
      ...
      <div className="card-content">
        <h3 className="camptitle" style={{ color: textColor }}>
          {title}
        </h3>
        ...
        <h5 style={{ color: textColor }}>Expires on {expiry}</h5>
     {dealvalue ?    <h5 style={{ color: textColor }}>On value of $ {dealvalue}</h5>:null}
        {discountValue ? (
          <h5 style={{ color: textColor }}>
            `On minimum purchase of $${discountValue}`
          </h5>
        ) : null}

        <p className="terms-points" style={{ color: textColor }}>
          {terms}
        </p>
        <p className="foot" style={{ color: textColor }}>
          The campaign can be redeemed once.
        </p>
        <p className="foot" style={{ color: textColor }}>
