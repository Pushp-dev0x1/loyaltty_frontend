...
const TermsConditions = ({
  ...
  return (
   <div className="flex-1 flex flex-col overflow-hidden max-h-full p-2 sm:p-4">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-gray-100 bg-opacity-50">
        <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-sm">
          ...
          <button
            ...
            className="mt-2 w-full px-4 py-1 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700"
          >
            Save
          </button>
        </div>
...
const CommunicationOptionsContainer = ({ selectedOptions, toggleOption }) => (
  <div className="border p-2 flex flex-col items-center justify-center mx-auto max-w-full termsbox rounded-lg">
...
const CommunicationOption = ({ name, selected, onChange }) => (
  <div
    className="flex items-center justify-start cursor-pointer w-full text-xm sm:text-sm p-1 mb-1"
